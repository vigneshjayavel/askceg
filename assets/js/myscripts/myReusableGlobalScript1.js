...
$(document).ready(function(){
    ...
    */
    ...
    $(".typeahead").typeahead({
        ...
        items:11,
        menu: '<ul id="ajaxSearchDropdown" style="position:fixed;margin-left:0px;font-size:16px;left:0px !important;width:100% !important" class="span12 dropdown-menu"></ul>', //to stretch the box
