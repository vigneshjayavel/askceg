            ...
            <li><a href="<?php echo base_url() ?>ProfileController/viewCategory/cse">CSE</a></li>
              <li><a href="<?php echo base_url() ?>ProfileController/viewCategory/ece">ECE</a></li>
               <li><a href="<?php echo base_url() ?>ProfileController/viewCategory/IT">IT</a></li>
              ...
              <li><a href="<?php echo base_url() ?>ProfileController/viewCategory/clubs-organization">Clubs / Organizations</a></li>
